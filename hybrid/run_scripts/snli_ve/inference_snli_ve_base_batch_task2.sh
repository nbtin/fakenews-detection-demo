...
path=/mnt/d/data/COSMOS/OFA/run_scripts/snli_ve/checkpoints/checkpoint.gendata12_4000_best_snli_score_0.8290.pt
result_path=../../results/snli_ve
selected_cols=0,2,3,4,5

CUDA_VISIBLE_DEVICES=0 python ../../inference_batch_task2.py \
    ${data} \
    --path=${path} \
    --user-dir=${user_dir} \
    --task=snli_ve \
